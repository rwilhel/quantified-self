...
/***/ (function(module, exports, __webpack_require__) {
	...
	const Meal = __webpack_require__(3);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Food.allFoodsToHTML = function () {
	  return this.getAllFoods().then(function (foodList) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Meal.calculateTotals = function () {
		var breakfast = parseInt($('.tot-calories')[0].innerText);
		var lunch = parseInt($('.tot-calories')[1].innerText);
		var dinner = parseInt($('.tot-calories')[2].innerText);
		var snacks = parseInt($('.tot-calories')[3].innerText);
		var totals = breakfast + lunch + dinner + snacks;
		$('#total-consumed-calories').text(totals);
		var overUnder = 2000 - totals;
		$('#total-remaining-calories').text(overUnder);
		if (overUnder < 0) {
			$('#total-remaining-calories').css("color", "red");
		} else {
	...
	Meal.clearChecks = function () {
		var allFoods = $(`.diary-foods-table`)[0].childNodes;

		allFoods.forEach(function (food) {
			food.children[2].children[0].checked = false;
		});
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	  Food.allFoodsToHTML().then(function (foodHTML) {
